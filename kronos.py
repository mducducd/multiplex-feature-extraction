"""
Kronos pretrained model loader and ViT architecture.
Adapted from: https://github.com/mahmoodlab/KRONOS
"""
...
try:
    ...
    logging.debug("xFormers is not available (Attention)")
...
try:
    ...
    logging.debug("xFormers is not available (Block)")
...
try:
    ...
    logging.debug("xFormers is not available (SwiGLU)")
